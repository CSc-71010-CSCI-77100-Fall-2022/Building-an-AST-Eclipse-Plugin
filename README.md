...
**Note**: This document is meant to be used in conjunction with [`InfoGatherer.java`][InfoGatherer] and [`MyVisitor.java`][MyVisitor]. You should read and understand both of these files.
...
[InfoGatherer]: https://github.com/CSc-71010-CSCI-77100-Fall-2022/Building-an-AST-Eclipse-Plugin/blob/master/src/asttrav/handlers/InfoGatherer.java
[MyVisitor]: https://github.com/CSc-71010-CSCI-77100-Fall-2022/Building-an-AST-Eclipse-Plugin/blob/master/src/asttrav/handlers/MyVisitor.java
